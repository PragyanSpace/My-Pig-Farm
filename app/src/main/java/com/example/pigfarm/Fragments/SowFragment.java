...
public class SowFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        getActivity().findViewById(R.id.Sow).setBackgroundColor(requireActivity().getColor(R.color.white));
        ...
        //query
        Query query = firebaseFirestore.collection("Records").document(firebaseUser.getUid()).collection("sow").orderBy("Tag", Query.Direction.ASCENDING);
        //recyleroption
                            ...
                            public boolean onMenuItemClick(MenuItem item) {
                                switch (item.getItemId()) {
                                    ...
                                    case R.id.delete:
                                        ...
                                        DocumentReference documentReference=firebaseFirestore.collection("Records").document(firebaseUser.getUid()).collection("sow").document(id);
