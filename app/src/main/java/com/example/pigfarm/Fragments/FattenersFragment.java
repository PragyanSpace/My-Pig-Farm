...
public class FattenersFragment extends Fragment {


    public FattenersFragment() {
        // Required empty public constructor
    }

    FirebaseUser firebaseUser;
    FirebaseFirestore firebaseFirestore;
    RecyclerView mfattenersRec;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        getActivity().findViewById(R.id.Fatterners).setBackgroundColor(requireActivity().getColor(R.color.white));
        ...
        getActivity().findViewById(R.id.Boar).setBackgroundColor(requireActivity().getColor(R.color.sap));


        // Inflate the layout for this fragment
        View view= inflater.inflate(R.layout.fragment_fatteners, container, false);

        FloatingActionButton mplus= view.findViewById(R.id.fattenersplus);


        firebaseUser = FirebaseAuth.getInstance().getCurrentUser();
        firebaseFirestore = FirebaseFirestore.getInstance();

        mfattenersRec=view.findViewById(R.id.fattenersRec);




        //query
        Query query = firebaseFirestore.collection("Records").document(firebaseUser.getUid()).collection("fatteners").orderBy("Tag", Query.Direction.ASCENDING);
        //recyleroption
                            ...
                            public boolean onMenuItemClick(MenuItem item) {
                                switch (item.getItemId()) {
                                    case R.id.edit:
                                        ...
                                        intent.putExtra("Category","fatteners");
                                        startActivity(intent);

                                        return true;
                                    case R.id.delete:

                                        DocumentReference documentReference=firebaseFirestore.collection("Records").document(firebaseUser.getUid()).collection("fatteners").document(id);
        ...
        mfattenersRec.setHasFixedSize(true);
        mfattenersRec.setLayoutManager(new LinearLayoutManager(getContext()));
        mfattenersRec.setAdapter(nadapter);


        RecyclerView.ItemDecoration divider=new DividerItemDecoration(getContext(),DividerItemDecoration.VERTICAL);
        mfattenersRec.addItemDecoration(divider);
