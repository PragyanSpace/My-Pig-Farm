...
public class GiltFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        getActivity().findViewById(R.id.Gilt).setBackgroundColor(requireActivity().getColor(R.color.white));
        ...
        View view= inflater.inflate(R.layout.fragment_gilt, container, false);

        FloatingActionButton mplus= view.findViewById(R.id.giltplus);


        firebaseUser = FirebaseAuth.getInstance().getCurrentUser();
        firebaseFirestore = FirebaseFirestore.getInstance();

        mgiltRec=view.findViewById(R.id.giltRec);




        //query
        Query query = firebaseFirestore.collection("Records").document(firebaseUser.getUid()).collection("Gilt").orderBy("Tag", Query.Direction.ASCENDING);
        //recyleroption
                            ...
                            public boolean onMenuItemClick(MenuItem item) {
                                switch (item.getItemId()) {
                                    case R.id.edit:
                                        ...
                                        intent.putExtra("Category","Gilt");
                                        startActivity(intent);

                                        return true;
                                    case R.id.delete:

                                        DocumentReference documentReference=firebaseFirestore.collection("Records").document(firebaseUser.getUid()).collection("Gilt").document(id);
        ...
        mgiltRec.setHasFixedSize(true);
        mgiltRec.setLayoutManager(new LinearLayoutManager(getContext()));
        mgiltRec.setAdapter(nadapter);


        RecyclerView.ItemDecoration divider=new DividerItemDecoration(getContext(),DividerItemDecoration.VERTICAL);
        mgiltRec.addItemDecoration(divider);
