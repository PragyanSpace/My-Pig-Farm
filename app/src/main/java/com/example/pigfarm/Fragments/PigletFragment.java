...
public class PigletFragment extends Fragment {


    public PigletFragment() {
        // Required empty public constructor
    }

    FirebaseUser firebaseUser;
    FirebaseFirestore firebaseFirestore;
    RecyclerView mpigletRec;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        getActivity().findViewById(R.id.Piglet).setBackgroundColor(requireActivity().getColor(R.color.white));
        ...
        View view= inflater.inflate(R.layout.fragment_piglet, container, false);

        FloatingActionButton mplus= view.findViewById(R.id.pigletplus);


        firebaseUser = FirebaseAuth.getInstance().getCurrentUser();
        firebaseFirestore = FirebaseFirestore.getInstance();

        mpigletRec=view.findViewById(R.id.pigletRec);




        //query
        Query query = firebaseFirestore.collection("Records").document(firebaseUser.getUid()).collection("piglet").orderBy("Tag", Query.Direction.ASCENDING);
        //recyleroption
                            ...
                            public boolean onMenuItemClick(MenuItem item) {
                                switch (item.getItemId()) {
                                    case R.id.edit:
                                        ...
                                        intent.putExtra("Category","piglet");
                                        startActivity(intent);

                                        return true;
                                    case R.id.delete:

                                        DocumentReference documentReference=firebaseFirestore.collection("Records").document(firebaseUser.getUid()).collection("piglet").document(id);
        ...
        mpigletRec.setHasFixedSize(true);
        mpigletRec.setLayoutManager(new LinearLayoutManager(getContext()));
        mpigletRec.setAdapter(nadapter);


        RecyclerView.ItemDecoration divider=new DividerItemDecoration(getContext(),DividerItemDecoration.VERTICAL);
        mpigletRec.addItemDecoration(divider);
